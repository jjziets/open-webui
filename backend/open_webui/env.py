...
WEBUI_AUTH_TRUSTED_API_KEY_HEADER = os.getenv('WEBUI_AUTH_TRUSTED_API_KEY_HEADER', None)
WEBUI_AUTH_TRUSTED_LITELLM_URL_HEADER = os.getenv('WEBUI_AUTH_TRUSTED_LITELLM_URL_HEADER', None)
WEBUI_LITELLM_DEFAULT_URL = os.getenv('WEBUI_LITELLM_DEFAULT_URL', 'https://api.ai.cryptolabs.co.za/v1')
WEBUI_LITELLM_DEFAULT_MODEL = os.getenv('WEBUI_LITELLM_DEFAULT_MODEL', '')
ENABLE_SSO_SIGNUP = os.getenv('ENABLE_SSO_SIGNUP', 'True').lower() == 'true'
